...
master_locs = ['Over', 'C21', 'Slab','Eagle A','Eagle B','Lodge','Manz','Riv','Sher','ACCT','HV','Pond','Oak A','Oak B','SG','SJ','Chal','SZ','Denali','Whit','Amp','Rosa','GLO9','Hawk','KC','Oak B','Cdr','LV','PP','HT','Sher','WM','LCR','SLIDE']

# Dict of class abbriviations to the length of the class
class_len = {'AERO': 2,'AN': 1,'ARCH': 1,'AS': 2,'ASTRO': 'N','ATB': 1,'BR': 1,'BS': 1,'CP': 1,'CS': 1,'CSI': 1,'D': 'N','DH': 1,'ED': 1,'FE': 2,'FWB': 1,'GE': 2,'G3': 'N','K': 'N','MN': 'N','NH': 'N','ORIENT': 1,'OS': 2,'PJ': 'N','QUAD': 1,'SQ': 1,'STAND': 1,'TB': 1,'UP': 1,'Ropes': 2,'SLIDE': 2,'LCR': 2,'WM': 2}
# class_locs and class_len in schools and sched == global variable
class_locs = {'AERO': ['Over', 'C21', 'Slab', 'Eagle A', 'Eagle B', 'Lodge', 'Manz'],'AN': ['Various'],'ARCH': ['Riv', 'Sher', 'Hawk', 'KC'],'AS': ['HV', 'HT', 'FOX'],'ASTRO': ['Over', 'ACCT', 'C21', 'Slab', 'Pond'],'ATB': ['Various'],'BR': ['Oak A', 'SG', 'Manz', 'Denali', 'SJ'],'BS': ['SJ', 'Whit', 'Oak A', 'Oak B'],'CP': ['Over', 'Manz'],'CS': ['Oak', 'Chal', 'Manz', 'Patio,', 'SZ'],'CSI': ['SJ', 'Oak A', 'Eagle A', 'Whit'],'D': ['Manz'],'DH': ['Various'],'ED': ['Oak A', 'Oak B', 'SJ', 'Whit'],'FE': ['Various'],'FWB': ['Pond'],'GE': ['Manz', 'Chal', 'Oak A', 'Eagle B'],'G3': ['Field'],'K': ['Oak A'],'MN': ['Oak A'],'NH': ['Various'],'ORIENT': ['GLO9', 'LV', 'PP'],'OS': ['A', 'B', 'C'],'PJ': ['Manz'],'QUAD': ['Quad'],'SQ': ['Cdr', 'Chal'],'STAND': ['Patio', 'Over', 'SG'],'TB': ['Various'],'UP': ['Amp', 'Rosa'],'Ropes': ['LCR', 'SLIDE', 'WM'],'LCR': ['LCR'],'SLIDE' :['SLIDE'],'WM': ['WM']}
...
class School:
    def __init__(self, name, subjects, arrive, depart, total_students,):
        self.name = name
...
if __name__ == '__main__':
    lakes = School(name="Lakes", subjects=['WM', 'FE', 'NH', 'ASTRO', 'UP','SQ','TB'] , arrive="Mon", depart='Wed', total_students=70)
    oak_park = School('Oak_Park',['LCR','GE','NH','PJ','SQ','TB','ATB'],arrive='Wed', depart='Fri', total_students=85)
    river = School('River', ['AERO', 'NH','D','CSI', 'SLIDE','ARCH','AN'], arrive = 'Mon',depart='Wed',total_students = 30)
